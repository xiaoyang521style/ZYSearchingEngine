...
- (void)initializeResource {
    ...
    if (dataMap) {
        ...
        NSString *strResourcesBundle = [[NSBundle mainBundle] pathForResource:@"ZYSearchingEngine" ofType:@"bundle"];
        
        NSString *resourceName = [[NSBundle bundleWithPath:strResourcesBundle] pathForResource:@"unicode_to_hanyu_pinyin" ofType:@"txt" inDirectory:nil];
...
+ (ZYChineseToPinyinResource *)getInstance {
    static ZYChineseToPinyinResource *sharedInstance=nil;
